                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Edit To Post here</h6>
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Image Section</h4>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <img src="{{$edit->image}}" class="img-fluid mt-2"  style="max-height:180px; max-width: 200px; margin:auto;" id="previewImg"  alt="image">
                                    </div>
