                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0">
                                        <thead>
                                            <tr>
                                               <th data-sort-initial="true" data-toggle="true" class="text-center">#SN</th>
                                                ...
                                                <th data-hide="phone, tablet"  class="text-center">Comics Category</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{$item->comics_category}}</td>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{route('comics-category-edit',$item->id)}}"><i class="fas fa-marker" style="font-size:20px;"></i></a>
