...
<form class="form p-t-20" action="{{route('comics-update',$edit->id)}}" method="post" enctype="multipart/form-data">
    ...
    <div class="row m-3">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Comics Edit Form</h4>
                    <h6 class="card-subtitle">Edit here</h6>

                    <div class="form-group">
                        <label for="title">Comics Title</label>
                        <div class="input-group">
                            <div class="input-group-addon"><i class="fab fa-battle-net"></i></div>
                            <input type="text" class="form-control" id="title" name="comics_title" value="{{ $edit->comics_title }}"/>
                        </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="type" name="comics_link" value="{{ $edit->comics_link }}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="type" name="comics_author" value="{{ $edit->comics_author }}"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12">
                            <textarea name="comics_description" id="editor">{!! $edit->comics_description !!}</textarea>
                        </div>
                        <div class="form-group">
