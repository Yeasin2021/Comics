        ...
        <div class="row">
          <div class="col-md-8">
            <div class="post-box">
              ...
              <div class="post-meta">
                <h1 class="article-title">{{ App\Models\Blog::first()->title}}</h1>
                <ul>
                  <li>
                    <span class="ion-ios-person"></span>
                    <a href="#">{{ App\Models\AboutMe::first()->name}}</a>
                  </li>
                  <li>
                    <span class="ion-pricetag"></span>
                    <a href="#">{{ App\Models\AboutMe::first()->designation }}</a>
                  </li>
                  <li>
              ...
              <ul class="list-comments">
                <li>
                  <div class="comment-avatar">
                    <img src="{{asset('/theme/assets/')}}/img/testimonial-2.jpg" alt="">
                  </div>
                ...
                <li>
                  <div class="comment-avatar">
                    <img src="{{asset('/theme/assets/')}}/img/testimonial-4.jpg" alt="">
                  </div>
                  <div class="comment-details">
